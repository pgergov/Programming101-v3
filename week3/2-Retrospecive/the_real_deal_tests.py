...
class TheRealDealTests(unittest.TestCase):
    ...
    def test_if_number_has_prime_number_of_divisors(self):
        self.assertTrue(the_real_deal.prime_number_of_divisors(7))
        self.assertTrue(the_real_deal.prime_number_of_divisors(9))
        self.assertFalse(the_real_deal.prime_number_of_divisors(8))
    ...
    def test_number_containing_all_digits(self):
        self.assertTrue(the_real_deal.contain_digits(402123, [0, 3, 4]))
        self.assertFalse(the_real_deal.contain_digits(123456789, [1, 2, 3, 0]))
    ...
    def test_matrix_bombing(self):
        self.assertEqual(the_real_deal.matrix_bombing_plan(
            [[1, 2, 3], [4, 5, 6], [7, 8, 9]]), {(0, 0): 42,
                                                 (0, 1): 36,
                                                 (0, 2): 37,
                                                 (1, 0): 30,
                                                 (1, 1): 15,
